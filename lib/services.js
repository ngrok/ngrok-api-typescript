...
class KubernetesOperators {
    ...
    _asyncList(beforeId, limit = '100') {
        return __asyncGenerator(this, arguments, function* _asyncList_23() {
            ...
            while (nextPage) {
                const pagedList = yield __await(this._pagedList(page));
                nextPage = pagedList.nextPageUri;
                const items = pagedList.operators;
                if (nextPage) {
                    page = {
                        beforeId: items[items.length - 1].id,
                        limit: limit,
     ...
     */
    getBoundEndpoints(id, beforeId, limit) {
        var e_24, _a;
        return __awaiter(this, void 0, void 0, function* () {
            const array = [];
            try {
                for (var _b = __asyncValues(this._getBoundEndpoints_asyncList(id, beforeId, limit)), _c; _c = yield _b.next(), !_c.done;) {
                    let item = _c.value;
                    array.push(item);
                }
            }
    ...
    _getBoundEndpoints_pagedList(arg) {
        return this.httpClient
    ...
    _getBoundEndpoints_asyncList(id, beforeId, limit = '100') {
        return __asyncGenerator(this, arguments, function* _getBoundEndpoints_asyncList_1() {
            let nextPage = 'initial loop';
            ...
            page.id = id;
            while (nextPage) {
                const pagedList = yield __await(this._getBoundEndpoints_pagedList(page));
                nextPage = pagedList.nextPageUri;
                const items = pagedList.endpoints;
                if (nextPage) {
                    page = {
...
exports.KubernetesOperators = KubernetesOperators;
/**
