...
var Ngrok = /** @class */ (function () {
    ...
    function Ngrok(_a) {
        ...
        this.EndpointSAMLModule = {
            replace: function (arg) {
                return _this.rest.url("/endpoint_configurations/" + arg.id + "/saml").put(arg).json();
            },
            get: function (arg) {
                return _this.rest.url("/endpoint_configurations/" + arg.id + "/saml").get().json();
            },
            delete: function (arg) {
                return _this.rest.url("/endpoint_configurations/" + arg.id + "/saml").delete().json();
            },
        };
        this.EndpointOIDCModule = {
            replace: function (arg) {
                return _this.rest.url("/endpoint_configurations/" + arg.id + "/oidc").put(arg).json();
            },
            get: function (arg) {
                return _this.rest.url("/endpoint_configurations/" + arg.id + "/oidc").get().json();
            },
            delete: function (arg) {
                return _this.rest.url("/endpoint_configurations/" + arg.id + "/oidc").delete().json();
            },
        };
        this.ReservedAddrs = {
