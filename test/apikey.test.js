...
describe('valid ngrok api key', () => {
            ...
            .reply(200,
                {
                    "keys": [{
                        ...
                        token: null
                    }], uri: "https://api.ngrok.com.lan/api_keys", "next_page_uri": null
                }
            )
    ...
    test('api keys invalid id', () => {
        ...
        expect.assertions(1);
        return ngrok.APIKeys.get({id: '1000'})
            .catch(data => {
                expect(JSON.stringify(data)).toMatch('the identifier is not a valid identifier')
            });
    });
});
